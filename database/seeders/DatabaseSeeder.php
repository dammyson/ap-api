...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('transaction_types')->insert([
            ['name' => 'Purchase', 'description' => 'Transaction for purchasing items'],
            ['name' => 'Refund', 'description' => 'Transaction for refunding purchases'],
            ['name' => 'Transfer', 'description' => 'Transaction for transferring funds'],
            ['name' => 'Payment', 'description' => 'Transaction for making payments'],
            ['name' => 'Withdrawal', 'description' => 'Transaction for withdrawing funds'],
        ]);
        ...
        GameCategory::create([
            'name' => 'Puzzle',
            'description' => 'Puzzle games category'
        ]);
