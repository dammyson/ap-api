...
namespace App\Http\Requests\Soap\Booking;
...
class CreateBookingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'CreateBookOriginDestinationOptionList.*.ondControlled' => 'required|string',
            'CreateBookOriginDestinationOptionList.*.sector' => 'required|string',
            'CreateBookOriginDestinationOptionList.*.codeshare' => 'required|string',
            ...
            'CreateBookOriginDestinationOptionList.*.iatciFlight' => 'required|string',
            ...
            'CreateBookOriginDestinationOptionList.*.secureFlightDataRequired' => 'required|string',
            ...
            'airTravelerList.*.contactPersonShareMarketInd' => 'required|string',
            'airTravelerList.*.contactPersonMarkedForSendingRezInfo' => 'required|string',
            ...
            'airTravelerList.*.phoneNumberMarkedForSendingRezInfo' => 'required|string',
            ...
            'airTravelerList.*.documentInfoList.*.shareMarketInd' => 'required|string',
            ...
            "airTravelerChildList.*.contactPersonShareContactInfoChild" => "required|string",
            ...
            'airTravelerChildList.*.documentInfoList.*.shareMarketInd' => 'required|string',
            ...
            "contactInfoList.*.companyFullName" => "sometimes",
            "contactInfoList.*.companyLegalName" => "sometimes",
            "contactInfoList.*.taxNumber" => "sometimes",
            "contactInfoList.*.taxOffice" => "sometimes",
            "contactInfoList.*.addressLineList" => "sometimes",
            "contactInfoList.*.adressUseType" => "sometimes",
            "contactInfoList.*.bldgRoom" => "sometimes",
            "contactInfoList.*.cityCode" => "sometimes",
            "contactInfoList.*.cityName" => "sometimes",
            "contactInfoList.*.countryCode" => "sometimes",
            "contactInfoList.*.countryName" => "sometimes",
            "contactInfoList.*.formatted" => "sometimes",
            "contactInfoList.*.postalCode" => "sometimes",
            "contactInfoList.*.preferred" => "sometimes",
            "contactInfoList.*.shareMarketInd" => "sometimes",
            "contactInfoList.*.stateProvince" => "sometimes",
            "contactInfoList.*.streetNumber" => "sometimes",
            "contactInfoList.*.email" => "sometimes",
            "contactInfoList.*.markedForSendingRezInfo" => "sometimes",
            "contactInfoList.*.givenName" => "sometimes",
            "contactInfoList.*.surname" => "sometimes",
            "contactInfoList.*.areaCode" => "sometimes",
            "contactInfoList.*.phoneNumberCountryCode" => "sometimes",
            "contactInfoList.*.phoneNumberMarkedForSendingRezInfo" => "sometimes",
            "contactInfoList.*.phoneUseType" => "sometimes",
            "contactInfoList.*.subscriberNumber" => "sometimes",
            "contactInfoList.*.socialSecurityNumber" => "sometimes",
            "contactInfoList.*.useForInvoicing" => "sometimes",
