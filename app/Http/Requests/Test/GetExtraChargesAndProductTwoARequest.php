...
class GetExtraChargesAndProductTwoARequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "bookFlightSegmentList.*.ondControlled" => "required|boolean", 
            "bookFlightSegmentList.*.sector" => "required|string", 
            "bookFlightSegmentList.*.codeShare" => "required|boolean", 
            "bookFlightSegmentList.*.distance" => "required|string",
            "bookFlightSegmentList.*.airEquipType" => "required|string", 
            "bookFlightSegmentList.*.changeOfGuage" => "required|boolean", 
            ...
            "bookFlightSegmentList.*.iatciFlight" => "required|boolean", 
            ...
            "bookFlightSegmentList.*.secureFlightDataRequired" => "required|boolean", 
