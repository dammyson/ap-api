<?php
array:1 [ // app\Http\Controllers\Test\AvailableSpecialController.php:72
    "AirAvailSpecialServicesResponse" => array:1 [
      "availSpecialServices" => array:1 [
        "availSpecialServiceList" => array:3 [
          "availPkgInfos" => ""
          "availableSSRList" => array:16 [
            0 => array:15 [
            ...
            7 => array:16 [
              ...
              "code" => "AVIH"
              "exchangeable" => "true"
              "explanation" => "AVIH-Animal in hold Small"
              "extraBaggage" => "false"
              "free" => "false"
              "freeTextInRequest" => "MN"
              "groupCode" => "PET"
